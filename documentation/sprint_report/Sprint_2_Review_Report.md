...
- Integrate Scan API to scan the user's resume;
- Integrate LLM API to get request and generate cover letter;
- Prepare topic presentation;
- Sprint 2 planning report;
- Create the frontend Prototype (Figma);
- Authentication (Register and Login) and Manage profile;
- Do sprint 2 review;
