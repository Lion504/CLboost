...
/**
 * Data class representing extracted information from a scanned resume.
 * This class holds the structured data that will be displayed in the confirmation form.
 */
