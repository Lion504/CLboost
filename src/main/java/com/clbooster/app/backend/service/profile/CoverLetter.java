...
public class CoverLetter {
    ...
    public Timestamp getTimestampEdited() {
        return timestampEdited;
    }

    public void setTimestampEdited(Timestamp timestampEdited) {
        this.timestampEdited = timestampEdited;
    }
    ...
    public String toString() {
        return "CoverLetter{id=" + id + ", pin=" + pin + ", timestampEdited=" + timestampEdited + ", filePath='"
                + filePath + "'}";
    }
}
