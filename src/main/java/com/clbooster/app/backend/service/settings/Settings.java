...
public class Settings {
    ...
    public boolean isStoreInCloud() {
        return storeInCloud;
    }

    public void setStoreInCloud(boolean storeInCloud) {
        this.storeInCloud = storeInCloud;
    }

    public boolean isAllowAiTraining() {
        return allowAiTraining;
    }

    public void setAllowAiTraining(boolean allowAiTraining) {
        this.allowAiTraining = allowAiTraining;
    }
