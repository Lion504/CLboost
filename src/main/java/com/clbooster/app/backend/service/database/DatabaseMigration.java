...
public class DatabaseMigration {
    ...
    public static void runMigration() {
        ...
        String[] createProfileTranslationTable = {
        ...
        String[] createSystemMessageTranslationTable = {
            "CREATE TABLE IF NOT EXISTS system_message_translation (",
