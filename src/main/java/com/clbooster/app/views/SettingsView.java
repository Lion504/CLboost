...
public class SettingsView extends VerticalLayout {
    ...
    public SettingsView() {
        ...
        // Visually style as button group
        themeGroup.addThemeVariants(
            com.vaadin.flow.component.radiobutton.RadioButtonGroupVariant.LUMO_VERTICAL);
        ...
        Paragraph langSub = new Paragraph(
            "Select your preferred language for the interface and AI generation.");
        langSub.getStyle().set("color","#6b7280").set("margin-top","0");

        Select<String> langSelect = new Select<>();
        langSelect.setLabel("Language");
        langSelect.setItems("English", "Finnish (Suomi)", "Swedish (Svenska)",
        ...
        Checkbox emailNotifs   = toggleRow("Email Notifications",
            "Weekly summaries and match alerts", true);
        Checkbox pushNotifs    = toggleRow("Push Notifications",
            "Real-time generation status", false);
        Checkbox productUpdates = toggleRow("Product Updates",
            "New features and tips", true);
